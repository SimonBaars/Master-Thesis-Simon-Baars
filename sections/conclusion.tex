...
\todo{Possible stuff: future work might be a threat to validity}
\todo{Implementation specific for CloneRefactor: limited validation}

\section{Future work} \label{sec:future_work}
\todo{Move part of future work to discussion}
