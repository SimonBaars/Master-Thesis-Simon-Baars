...
To find out whether clones should be refactored (RQ3) we collect data about the applied refactorings. We use this data to find out whether a specific refactoring succeeds in improving the maintainability of the system. We define the following characteristics that have an impact on the refactoring of the clone class:
\begin{itemize}
...
\end{itemize}
These characteristics define the \textbf{input} of the refactoring. As an output, we measure the impact of applying these refactorings on system maintainability metrics. These metrics are derived from Heitlager et al. \cite{heitlager2007practical}. 
