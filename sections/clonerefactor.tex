...
In the example of figure \ref{fig:equalityarrays} the fragment on the left (consisting of N_1 and N_2) and the fragment on the right (consisting of N_3 and N_4) are two clone instances of a clone class. We calculate the variability of this clone instance as follows:
