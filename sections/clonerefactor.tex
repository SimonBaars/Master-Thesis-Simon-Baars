...
We can deduct the change of the values of these metrics by considering the transformations that are done by the refactoring. We calculate these metrics as follows:
