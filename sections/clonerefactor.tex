...
In figure \ref{fig:2rvariabilityhigh4} we display the equality arrays for each of the lines of a code example with a complex distribution of cloned fragments. 
