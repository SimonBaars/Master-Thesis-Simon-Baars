...
\frac{|\{x>0 \land y>0 \land x \neq y\text{ }|\text{ }x \in E_1 \cup E_2, y \in E_3 \cup E_4\}|}{(s_1+s_2)+(s_3+s_4)}*100
\end{equation}
...
E_1\text{ is cloned with }E_2\text{ iff }|E_1|=|E_2| \land \forall {x<0 \Rightarrow x=y | x \in E_1, y \in E_2}
\end{equation}
