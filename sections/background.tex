...
\section{Maven}
Maven is a build automation tool, mainly used with the Java programming language. Maven has a simple ecosystem to configure and fetch a projects' dependencies binaries and source code.

In this study we use Maven to analyze software systems in more depth. We parse and analyze the libraries on which they are dependent.
