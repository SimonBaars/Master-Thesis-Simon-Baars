...
\begin{figure}[H]
	...
	\caption{Example of a clone pair, as found in the \href{https://github.com/Danny02/JOpenCTM}{JOpenCTM} project.}
	\label{fig:clonepair}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Example of a clone class, as found in the \href{https://github.com/Danny02/JOpenCTM}{JOpenCTM} project.}
