...
\newcommand{\highlightYellow}{\makebox[0pt][l]{\color{yellow}\rule[-4pt]{1\linewidth}{14pt}}}
\newcommand{\highlightBlue}{\makebox[0pt][l]{\color{blue}\rule[-4pt]{1\linewidth}{14pt}}}
\newcommand{\highlightPurple}{\makebox[0pt][l]{\color{purple}\rule[-4pt]{1\linewidth}{14pt}}}
\begin{figure}
\begin{parcolumns}{3}
\colchunk[1]{
\begin{javacode}
