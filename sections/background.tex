...
\begin{multicols}{2}
\begin{lstlisting}[caption={Functions that are type 2 clones but functionally completely different.},language=Java,escapechar=|,tabsize=2, breaklines=true, xleftmargin=.25in, keywordstyle=\color{pblue},basicstyle=\small]
// Hello.java
