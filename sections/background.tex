...
\rowcolor[HTML]{FFFFFF}
N & Node \ref{jiang2007deckard} & Set of tokens. & \begin{tabular}[c]{@{}l@{}}A statement or declaration in a \\ codebase.\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{Range:} The range this node\\spans.\end{tabular} \\
\rowcolor[HTML]{EFEFEF}
