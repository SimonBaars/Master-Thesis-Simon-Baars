...
\rowcolor[HTML]{FFFFFF}
N & Node \cite{jiang2007deckard} & Set of tokens. & \begin{tabular}[c]{@{}l@{}}A statement or declaration node\\in the AST of a codebase.\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{Range (R):} The range this node\\spans.\end{tabular} \\
\rowcolor[HTML]{EFEFEF}
...
% TODO: Sander - leg ook nog even in 1 zin uit wat een lezer aan al deze info heeft
