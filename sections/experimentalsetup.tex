...
Cloned nodes are flagged as \textit{Superclass} if the classes in which these clones are found are parent and child class of each other. Here, the classes of these nodes follow the same definition as stated in the previous section.

Cloned nodes are flagged as \textit{Siblings} if the classes in which these clones are found all share the same parent and this parent class is not external.

Cloned nodes are flagged as \textit{First Cousin} if the classes in which these clones are found all share the same parent and this parent class is not external.
