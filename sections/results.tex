...
\begin{figure}[H]
  ...
  \caption{The effect of token volume on the delta maintainability score of the refactored system}
...
\begin{figure}[H]
  ...
  \caption{The effect of token volume on the delta volume of the refactored system}
  \label{fig:volume}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{The effect of token volume on the number of parameters of the refactored system}
  \label{fig:numberofparameters}
\end{figure}

In Figure~\ref{fig:complexity} we show the average delta complexity when clones with the specified token volume are refactored.

\begin{figure}[H]
  \includegraphics[width=1\textwidth]{img/complexity}
  \caption{The effect of token volume on the complexity of the refactored system}
