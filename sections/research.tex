...
public boolean containsOnlyRedCircles(List<Circle> listOfCircles){
	return listOfCircles.stream().allMatch(c -> c.isRed());
}

public Apple getEatableAppleFromBasket(FruitBasket<Apple> appleBasket){
	return appleBasket.getFruitContainer().getAppleByCriterium(a -> a.hasNotYetBeenEaten());
}
\end{lstlisting}
