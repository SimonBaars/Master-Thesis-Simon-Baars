...
In figure \ref{fig:type3} a single statement is added. This statement is found in between cloned lines. There is a \textit{gap} of non-cloned lines in between two clone classes. For type 3R, the size of this gap is bounded by a threshold. It is calculated by the following formula:
