...
Consider the example in figure \ref{fig:type2literal1}. In this example, the two methods have two literals that differ between them. We can perform an ``Extract method'' refactoring on these to get the result in figure \ref{fig:type2literal2}. In this process, we create a method parameter for the corresponding literal.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{img/type2literal1}
  \caption{Literal variability.}
  \label{fig:type2literal1}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth]{img/type2literal2}
  \caption{Literal variability refactored.}
  \label{fig:type2literal2}
\end{figure}
