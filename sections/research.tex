...
$$\text{Diff = Amount that differ from other clone instances in the clone class}$$
$$\text{Total = Total number in the clone instance}$$
$$\text{l = Number of literals}$$
$$\text{v = Number of variables}$$
$$\text{m = Number of method calls}$$
$$\text{t = Number of tokens}$$
