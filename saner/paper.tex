...
\begin{itemize}
    ...
    \begin{itemize}
        \item[$\square$] \textbf{Same Method}: All clone instances are in the same method.
...
The location of a clone instance helps determine what refactoring techniques can be applied to refactor such clones. We define the following categories by which we analyze the location of clones:
\begin{enumerate}
