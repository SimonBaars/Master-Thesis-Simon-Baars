...
We define the following characteristics of the extracted method and/or the call: \todo{why these?}
\begin{itemize}
...
\end{itemize}
We hypothesize that these characteristics are the main factors influencing the impact on the maintainability of the system as a result of refactoring the clone. \todo{why?}
...
Our goal is analysing whether automated refactoring of code clones leads to an improved maintainability. We first validate our automated refactoring tool, CR. Next, we run our tool on a reference corpus and measure the change in the maintainability score.
