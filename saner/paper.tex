...
We explain the corpus used for our experiments in Sec.~\ref{}
...
\subsection{Tool Evaluation}\label{sec:evaluation}
...
\subsection{Minimum clone size}\label{sec:thresholds}
