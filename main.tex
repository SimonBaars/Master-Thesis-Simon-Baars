...
\renewcommand{\maketitle}{%
	...
	\begin{center}
		...
		\email{author email}\\
		\vspace{11pt}
		July 16, 2017, \pageref{LastPage} pages
	\end{center}
	\vfill
	\begin{tabular}{ll}
		\textbf{Research supervisor:} 	& Name academic supervisor, \email{academic supervisor email} \\
		\textbf{Host/Daily supervisor:} & Name industry/daily supervisor, \email{industry supervisor email}\\
		\textbf{Host organisation/Research group:} & Name Host organization/Research group, \url{website organization/research group}
	\end{tabular}
	\uvacoverfoot
	\newpage
