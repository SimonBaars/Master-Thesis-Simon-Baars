...
\renewcommand{\maketitle}{%
	...
	\vspace{60pt}
	\begin{center}
		{\Huge\bfseries Improving Software Maintainability through Automated Refactoring of Code Clones \par}
		% Earlier versions:
		% Towards Automated Refactoring of Code Clones in Object-Oriented Programming Languages
    % Towards Automated Improvement of Software Maintainability through Automated Refactoring of Code Clones
		\vspace{44pt}
		{\Large\bfseries Simon Baars \par}
		\email{simon.mailadres@gmail.com}\\
		\vspace{11pt}
		August 24, 2019, \pageref{LastPage} pages
	\end{center}
	\vfill
	\begin{tabular}{ll}
		\textbf{Academic supervisor:} Dr. Ana Oprescu, \email{ana.oprescu@uva.nl} \\
		\textbf{Host supervisor:} Xander Schrijen MSc., \email{x.schrijen@sig.eu}\\
		\textbf{Host organisation:} Software Improvement Group (SIG), \url{http://sig.eu/}
	\end{tabular}
	\uvacoverfoot
	\newpage
