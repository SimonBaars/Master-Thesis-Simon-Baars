...
Our initial experiments look into how many clones are found in different contexts (see Sec.~\ref{sec:context}). This results in the Table~\ref{tab:relation}. In this table, the number of clone classes found for the entire corpus for different relations is shown.
