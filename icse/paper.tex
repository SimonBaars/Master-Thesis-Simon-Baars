...
Top-level Node is not a Statement & 19,887 & 4,607 \\
...
\begin{figure*}
  ...
  \caption{Size in tokens of the refactored clone vs maintainability. Maintainability on the primary axis and amount of refactorings on the secondary axis.}
  \label{fig:duplication}
\end{figure*}

\subsubsection{Relation}
Table \ref{tab:relation_refactor} shows our data regarding how different relations influence maintainability. We have marked rows based on less than 100 refactorings red, as their result does not have statistical significance. For these results, we have set the minimum amount of tokens for clones to 18 because otherwise the small clones dominate the results and turn them all towards unmaintainable.

\begin{table}[]
\centering
\begin{tabular}{@{}lll@{}}
\toprule
Category & Maintainability Score & Number of Refactorings \\ \midrule
\rowcolor[HTML]{FFCCC9}
Common Hierarchy & 0,63 & 27 \\
Sibling & 0,53 & 664 \\
No Direct Superclass & 0,11 & 295 \\
Same Method & 0,06 & 740 \\
\rowcolor[HTML]{FFCCC9}
Superclass & 0,03 & 68 \\
Same Class & 0,02 & 1273 \\
External Superclass & 0,01 & 209 \\
\rowcolor[HTML]{FFCCC9}
No Indirect Superclass & -0,06 & 36 \\
Same Interface & -0,07 & 269 \\
\rowcolor[HTML]{FFCCC9}
First Cousin & -0,19 & 54 \\
External Ancestor & -0,28 & 154 \\
\rowcolor[HTML]{FFCCC9}
Ancestor & -0,52 & 5 \\ \bottomrule
\end{tabular}
...
\begin{tabular}{@{}lll@{}}
\toprule
Return Value & Maintainability Score & Number of Refactorings \\ \midrule
Return & 0,20 & 421 \\
Void & 0,19 & 2052 \\
Declare & 0,03 & 1318 \\
\rowcolor[HTML]{FFCCC9}
...
Figure \ref{fig:arguments} shows how an increase in arguments lowers the maintainability of the refactored code. On the
