...
\end{itemize}
CloneRefactor then removes all cloned code and replaces it with a method call to the newly created method. In case of a return value, we either assign the call result, declare it or return it accordingly.
