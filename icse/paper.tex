...
Our initial experiments look into how many clones are found in different contexts (see Sec.~\ref{sec:context}). This results in the Table~\ref{tab:relation}.
...
\begin{tabular}{@{}llll@{}}
\toprule
Category & Relation & Amount of clone classes & Total \\ \midrule
...
\caption{Amount of clone classes per clone relation}
\label{tab:relation}
\end{table}
