...
Fig.~\ref{fig:arguments} shows how an increase in parameters lowers the maintainability of the refactored code. On the primary x-axis the maintainability is displayed, the secundary x-axis shows the amount of refactorings and the y-axis shows the amount of parameters.
