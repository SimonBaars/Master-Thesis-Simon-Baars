...
This research relies on the assumption that the maintainability model proposed by Heitlager et al.~\cite{heitlager2007practical} gives a good indication of the actual maintainabilty of a system. Furthermore, we rely on that the scores of different metrics have an equal weight relative to each other, as for our aggregation of the scores.   
