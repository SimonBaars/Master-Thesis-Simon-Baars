...
None of the surveyed tools had all the desired characteristics. Also, the output of these clone detection tools cannot be post-processed to match the clone definition proposed in Sec.~\ref{sec:research}. This is mainly because the automatically refactorable clones are not necessarily a subset of the clones detected by these tools (see Sec.~\ref{sec:} and will thus require an analysis of the entire system.
