...
Where $L_{\text{clone type}}$ is the set of cloned lines found by the rules of the specified clone type.
...
Where $L_{\text{clone type}}$ is the set of cloned lines found by the rules of the specified clone type. The reason that T2R and T3R are not subsets of T2 and T3, is that T2R and T3R allow variability in method calls which can differ in structure. T2 and T3 do not allow such differences.
