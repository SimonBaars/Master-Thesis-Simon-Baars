...
%TODO: What are clone classes, what are clone instances, etc.
...
Running our clone detection script, CloneRefactor, over this corpus gives the following results:

\begin{table}[H]
  \begin{center}
  \caption{CloneRefactor results for Java projects corpus \cite{githubCorpus2013}.}
  \bigskip
\begin{tabular}{|l|l|}
\hline
...
\begin{table}[H]
  \begin{center}
  \caption{Clone relations}
  \bigskip
\begin{tabular}{|l|l|l|} \hline
\textbf{Relation}  & \textbf{Amount} & \textbf{Percentage} \\ \hline
Unrelated          & 13.537           & 39,39               \\ \hline
Same Class          & 8.341            & 24,27               \\ \hline
Sibling            & 5.978            & 17,39               \\ \hline
...
From these results we can see, somewhat surprisingly, that in our
...
\begin{enumerate}
  \item \textbf{Full Method/Class/Interface/Enumeration:} A clone that spans a full class, method, interface or enumeration, including its declaration.
  \item \textbf{Partial Method:} A clone that spans a method partially, optionally including its declaration.
  ...
  \item \textbf{Includes Fields:} A clone that spans a combination of fields and other things, like methods.
