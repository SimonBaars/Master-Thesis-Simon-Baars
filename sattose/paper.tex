...
\begin{enumerate}
  ...
  \item \textbf{Several Methods:} A clone that spans over two or more methods and/or method bodies.
  \item \textbf{Only Fields:} A clone that spans only global variables.
  \item \textbf{Includes Fields/Constructor:} A clone that spans a combination of fields/constructors and other things.
