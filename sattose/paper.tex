...
\begin{figure}[H]
  \caption{Duration in minutes of identifying clones for clone type definitions.}
    \includegraphics[width=1\columnwidth]{img/DurationChart}
...
Unrelated          & 4,762 & 38.14            \\ \hline
Same Class          & 3,131 & 25.07             \\ \hline
Sibling               & 1,949 & 15.61            \\ \hline
Same Method         & 1,685 & 13.49             \\ \hline
External Superclass   & 558 & 4.47             \\ \hline
First Cousin          & 197 & 1.58           \\ \hline
Superclass          & 118 & 0.94           \\ \hline
Common Hierarchy    & 73 & 0.58            \\ \hline
Ancestor          & 14 & 0.11          \\ \hline
\end{tabular}
\end{center}
\end{table}
...
Method Level        & 19,075 & 58.23            \\ \hline
Class Level        & 12,207 & 37.27            \\ \hline
Constructor Level    & 1,080 & 3.30           \\ \hline
Interface Level   & 247 & 0.75           \\ \hline
Enum Level         & 147 & 0.45            \\ \hline
\end{tabular}
\end{center}
\end{table}
...
\begin{tabular}{|l|l|l|}
  ...
  Partial Method     & 18,791 & 57.37 \\ \hline
  Several Methods         & 8,514 & 25.99 \\ \hline
  Includes Constructor  & 1,213 & 3.70 \\ \hline
  Includes Field        & 1,487 & 4.54 \\ \hline
  Partial Constructor      & 1,078 & 3.29 \\ \hline
  Only Fields           & 888 & 2.71 \\ \hline
  Full Method           & 284 & 0.87 \\ \hline
  Includes Class Declaration  & 258 & 0.79 \\ \hline
  Other Categories    & 243 & 0.74 \\ \hline
\end{tabular}
\end{center}
\end{table}
...
Is not a partial method     & 4,806 & 38.49 \\ \hline
Complex control flow  & 3,158 & 25.29 \\ \hline
Spans part of a block   & 3,152 & 25.24 \\ \hline
Can be extracted & 1,371 & 10.98 \\ \hline
\end{tabular}
\end{center}
\end{table}
