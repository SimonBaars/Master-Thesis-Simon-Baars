...
\begin{itemize}
  ...
  \item \textbf{Compare the equality the fully qualified identier for variable usages.} Two cloned lines might use a variable with the same name, but different types. This might pose serious challenges on refactoring, as the variables might not concern the same object or primitive. To check this, we need to track the declaration of variables and from this infer the fully qualified indentifier of its type.
\end{itemize}
