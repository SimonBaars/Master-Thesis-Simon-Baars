...
\hline
\textbf{Clone Detection Tool}                                                                                                                           & \textbf{Short Description}                                                          & \textbf{(1)}                  & \textbf{(2)} & \textbf{(3)} & \textbf{(4)} \\ \hline
Siamese \cite{ragkhitwetsagul2019siamese}                                                                                                              & \begin{tabular}[c]{@{}l@{}}ANTRL based\\ large scale clone\\ detection\end{tabular} &  &             &             & \checkmark            \\ \hline
NiCAD \cite{roy2008nicad, cordy2011nicad} \footnote{This clone detection tool has also been used by Fontana et al \cite{fontana2012duplicated}}      & \begin{tabular}[c]{@{}l@{}}Duplicated code\\ refactoring advisor\end{tabular}       & ?                             & ?            & ✗            & ✓            \\ \hline
CPD \cite{roy2009comparison}\footnote{CPD is a Clone Detection tool that is part of PMD. PMD is a widely used tool for static code analysis in Java.} & \begin{tabular}[c]{@{}l@{}}Widely used clone\\ detection tool\end{tabular}          & ✓                             & ✓            & ✗            & ✗            \\ \hline
\begin{tabular}[c]{@{}l@{}}CCFinder \cite{kamiya2002ccfinder}\\ CCFinderX\\ D-CCFinder \cite{livieri2007very}\end{tabular}                            & \begin{tabular}[c]{@{}l@{}}Widely used\\ clone detection\\ framework\end{tabular}   & ✓                             & ✓            & ✗            & ✗            \\ \hline
CCFinderSW \cite{semura2017ccfindersw}                                                                                                                 & \begin{tabular}[c]{@{}l@{}}ANTRL based\\ clone detection\end{tabular}               & ✓                             & ✗            & ✗            & ✓            \\ \hline
\begin{tabular}[c]{@{}l@{}}SourcererCC \cite{sajnani2016sourcerercc}\\ Oreo \cite{saini2018oreo}\end{tabular}                                         & \begin{tabular}[c]{@{}l@{}}These tools detect\\ all types of clones\end{tabular}    & ✓                             & ✗            & ✗            & ✓            \\ \hline
BigCloneEval \cite{svajlenko2016bigcloneeval}                                                                                                          & \begin{tabular}[c]{@{}l@{}}Large-scale clone\\ detection\end{tabular}               & ✓                             & ✓            & ✗            & ✗            \\ \hline
Deckard \cite{jiang2007deckard}                                                                                                                        & \begin{tabular}[c]{@{}l@{}}ANTRL Parse Tree\\ based Clone Detector\end{tabular}     & ✓                             & ✗            & ✓            & ✗            \\ \hline
\end{tabular}
\end{center}
\end{table}
