...
In this chapter, we will discuss type-2 and type-3 clones (because type-1 clones are straightforward and type-4 clones are out of the scope for this study).
...
Because of that, for this research we have looked into a redefinition of type 2 clones to be able to detect such clones that can and should be merged. Our definition ensures functional similarity by considering types, having a distinction between different variables and defining thresholds for variability in literals.
