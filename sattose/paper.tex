...
Amount of tokens (excluding whitespace, comments and newlines.)                                                   & 11,643,194 \\ \hline
\end{tabular}
\end{center}
\end{table}

\subsection{Clone detection results}
Currently, we have implemented two clone detection algorithms into CloneRefactor. The first one finds clones by comparing tokens (excluding whitespace, comments and newlines). The second algorithm implements our type 1R, as explained in section \ref{chap:type1clones}.
...
\begin{tabular}{|l|l|}
\hline
 & \textbf{Token} & \textbf{Type 1R}
\begin{tabular}[c]{@{}l@{}}Amount of lines cloned (excluding\\ whitespace, comments and newlines.)\end{tabular} & 200,362 & 129,519 \\ \hline
Amount of statements/declarations cloned & 182,466 & 118,980 \\ \hline
Amount of tokens cloned (excluding whitespace, comments and newlines.) & 1,582,845 & 973,596 \\ \hline
\end{tabular}
\end{center}
\end{table}
