...
From this table, we can see that approximately ten percent of the clones can directly be refactored through method extraction. For the other clones, we must first build a catalog of appropriate refactorings.
