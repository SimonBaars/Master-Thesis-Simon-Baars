...
\begin{enumerate}
  \item \textbf{Full Method/Class/Interface/Enumeration/Constructor:} A clone that spans a full class, method, constructor, interface or enumeration, including its declaration.
