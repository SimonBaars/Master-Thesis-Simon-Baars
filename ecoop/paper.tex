...
We identify the factors of interest characterizing the impact on the maintainability of automatically applied refactorings. We find that the biggest influencing factor is the size of the clone. The majority of duplicates larger than 63 tokens improve maintainability when refactored. The amount of external data that needs to be passed to the extracted method is the other important factor: the majority of extracted methods requiring more than two parameters decrease maintainability.
\end{abstract}
