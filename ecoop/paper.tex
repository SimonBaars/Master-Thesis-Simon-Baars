...
\lstnewenvironment{javacode}[1][]{\lstset{language=Java,escapechar=|,tabsize=2, breaklines=true, xleftmargin=.25in, keywordstyle=\color{pblue},basicstyle=\small}}{}
...
\begin{adjustwidth}{-0.8in}{-0.8in}% adjust the L and R margins by 1 inch
...
\begin{lstlisting}[language=Java,escapechar=|,tabsize=2, breaklines=true, xleftmargin=.25in, keywordstyle=\color{pblue},basicstyle=\small]
...
Using the formulas in Eq.~\ref{eq:scoredev} and~\ref{eq:scoreref}
